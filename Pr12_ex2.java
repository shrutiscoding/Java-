...
public class Pr12_ex2 extends JFrame implements ActionListener{  
	...
	{  
		...
		l3=new JLabel("Addition of First and Second Number:");
        ...
        add(l);add(l1);add(tf1);add(l2);add(tf2);add(l3);add(tf3);add(b1);add(res); add(icon);
        setSize(600,600);  
        setLayout(null);  
        setVisible(true); 
    ...
    public void actionPerformed(ActionEvent e) {  
		...
		{
			res.setText("Please fill the values !!");
		}
		else
		{
